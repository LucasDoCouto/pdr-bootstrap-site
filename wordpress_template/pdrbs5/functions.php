...
// bootstrap 5 wp_nav_menu walker (utilizado no menu do topo)
class bootstrap_5_wp_nav_menu_walker extends Walker_Nav_menu
{
  ...
  function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
  {
    ...
    $active_class = (
        !strpos($item->url, '#') && // Evita que links com # sejam marcados com a propriedade active
        ($item->current || $item->current_item_ancestor || in_array("current_page_parent", $item->classes, true) || in_array("current-post-ancestor", $item->classes, true))
    ) ? 'active' : '';
